...
import Paths_pat_bang (version) -- Generated by Cabal
...
import Language.PatBang.Toploop
...
versionStr :: String
versionStr = "PatBang Interpreter version " ++ showVersion version
...
-- |Executes the PatBang interpreter.
main :: IO ()
main = do
