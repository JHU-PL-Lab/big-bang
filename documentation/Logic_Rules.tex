...
\begin{mathpar}
    \bbrule{Label}{
        ...
        \typeRel{\context}{\lbl e}{\lbl \alphaClosed_1}{\{\cellDown{\alphaClosed_2} <: \alphaClosed_1, \tauDownClosed <: \alphaClosed_2\} \cup \C}
    }
    ...
    \bbrule{Application}{
        ...
        \typeRel{\context}{e_1\ e_2}{\alphaClosed_1}%
                {\{\tauDownClosed_1 <: \alphaUp_2 \fto \alphaClosed_1, \cellDown{\alphaClosed_3} <: \alphaUp_2, \tauDownClosed_2 <: \alphaUp_3\} \cup \C_1 \cup \C_2} % TODO: add for final:  final \alphaUp_2
    }
    
    \bbrule{Case}{
        \typeRel{\context}{e}{\tauDownClosed}{\C} \\
        \overline{\gamma_n,\C'_n,\tauChi_n = \kappa(\tauDownClosed, \hat{b},\chi_n)} \\
        \overline{\typeRel{\context,\gamma_n}{e_n}{\tauDownClosed_n}{\C_n}}
    }{
        \typeRel{\context}{\gtCase e \gtOf \overline{\hat{b}\ \chi_n \fto e_n}}{\alphaClosed}{\C \cup \{\tauDownClosed <: \alphaUp,
            \gtCase \alphaUp \gtOf \overline{\tauChi_n \fto (\C_n \cup \C'_n\cup \{\tauDownClosed_n <: \alphaClosed\})}\}}
    }
    ...
    % TODO: add finality
    \bbrule{Variable Definition}{
        \typeRel{\context}{e_1}{\tauDownClosed_1}{\C_1} \\
        \typeRel{\context,x:\alphaClosed_1}{e_2}{\tauDownClosed_2}{\C_2}
    }{
        \typeRel{\context}{\gtDef x = e_1 \gtIn e_2}{\tauDownClosed_2}%
                {\C_1 \cup \C_2 \cup \{\cellDown{\alphaClosed_2} <: \alphaClosed_1, \tauDownClosed_1 <: \alphaClosed_2\}}
    }
    
    \bbrule{Variable Assignment}{
        \typeRel{\context}{e_1}{\tauDownClosed_1}{\C_1} \\
        \typeRel{\context}{e_2}{\tauDownClosed_2}{\C_2} \\
        x:\alphaClosed_1 \in \context
    }{
        \typeRel{\context}{x = e_1 \gtIn e_2}{\tauDownClosed_2}%
                {\C_1 \cup \C_2 \cup \{\alphaClosed_1 <: \cellUpS{\alphaClosed_2}, \tauDownClosed_1 <: \alphaClosed_2\}}
    }
    
    \bbrule{Hypothesis}{
        x:\alphaClosed_1 \in \context
    }{
        \typeRel{\context}{x}{\alphaClosed_2}{\{\alphaClosed_1 <: \cellUpG{\alphaClosed_2}\}}
    }
\end{mathpar}
...
\begin{mathpar}
    ...
    \bbrule{Backward Cell Propogation}{
        \cellDown{\alphaClosed_1} <: \cellUpS{\alphaClosed_2} \\
        \tauDownOpen <: \alphaClosed_2
    }{
        \tauDownOpen <: \alphaClosed_1
    }
    
    \bbrule{Forward Cell Propogation}{
        \cellDown{\alphaClosed_1} <: \cellUpG{\alphaClosed_2} \\
        \tauDownOpen <: \alphaClosed_1
    }{
        \tauDownOpen <: \alphaClosed_2
    }
