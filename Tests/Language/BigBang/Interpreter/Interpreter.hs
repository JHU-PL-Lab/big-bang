...
edgeCases = TestList [testEqualTypeMismatch, testNonexhaustiveCases, testUnbound, testTypeMismatch, testInvalidApplication]
...
simpleCases = TestList [testEqualLabel, testEqualChar, testEqualInt, testMinusInt, testCaseLabel, testCaseChar, testCaseInt, testCaseFun, testCaseLambda, testCaseUnit, testInterpretInt, testInterpretChar, testPlusInt, testLambdaAppl, testFuncAppl]
