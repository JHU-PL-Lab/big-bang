...
-}
module Data.IndexedSet.TemplateHaskell
( QueryDescriptor(..)
, createIndexedSet
) where
...
import Data.IndexedSet.Class as ISC
...
allFieldName idxStrName = mkName $ "_elementsOf" ++ idxStrName
...
indexName desc = mkName $ "_index" ++ queryName desc
